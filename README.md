...
- 大件数DBの起動、検索、一覧表示、Playerスクロールの体感速度を改善
- Watcher、サムネイル生成、全件整合処理が操作中のUIへ割り込みにくいよう調整
- インストーラーの版数整合性、アンインストール、スタートメニュー導線を修正
- DPI拡大環境でインストーラーのボタンとアンインストール表示を改善

### 2026-04-25 v1.0.4.0

- PlayerタブのWebView2再生、音量反映、全画面表示を安定化
- Watcherと検索、一覧更新のUI詰まりを軽減
- スキン切り替え時の再描画、catalog再利用、保存分離を強化
- インストーラーの更新判定と起動導線を調整

### 2026-04-10 v1.0.3.6

- タグ機能実装

### 2026-04-08 v1.0.3.5-r4
