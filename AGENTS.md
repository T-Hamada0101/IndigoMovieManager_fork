...
## ブランチ運用方針（AI必読）
- このブランチで作業するAIは、着手前に `AI向け_ブランチ方針_サムネ高速感優先_2026-03-11.md` を必ず読む
- 他ブランチの改善を取り込む時は、この文書の採用基準・禁止事項を優先する
- 当面の目標は「UIの詰まり解消」を最優先とし、「難読動画のサムネイル全作成」はそれを壊さない範囲で進める
...
- `Author` / `Committer` は匿名名義を基本とし、既定では `Anonymous <anonymous@example.invalid>` を使用する
...
- **このブランチで作業する全AIはここも読め！** 👉 [AI向け_ブランチ方針_サムネ高速感優先_2026-03-11.md](AI向け_ブランチ方針_サムネ高速感優先_2026-03-11.md)
