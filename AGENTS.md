...
## ブランチ運用方針（AI必読）
- このブランチで作業するAIは、着手前に `AI向け_ブランチ方針_future難読動画実験線_2026-03-11.md` を必ず読む
- このブランチは `future` の難読動画検証実験線として扱う
- 本線へ返す判断基準の最優先は、`workthree` でユーザーが感じるテンポ感を良くするか、少なくとも壊さないかである
