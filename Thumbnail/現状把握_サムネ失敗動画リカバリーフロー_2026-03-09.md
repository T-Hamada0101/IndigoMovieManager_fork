...
- [ThumbnailRepairWorkflowCoordinator.cs](./ThumbnailRepairWorkflowCoordinator.cs)
- [ThumbnailFailureFinalizer.cs](./ThumbnailFailureFinalizer.cs)
- [MainWindow.Watcher.cs](../Watcher/MainWindow.Watcher.cs)
- [サムネイルが作成できない動画対策.md](./サムネイルが作成できない動画対策.md)
- [Flowchart_サムネイル処理ワークフロー_Recovery詳細_2026-03-08.md](./Flowchart_サムネイル処理ワークフロー_Recovery詳細_2026-03-08.md)
