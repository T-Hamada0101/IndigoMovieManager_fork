...
| 役割 | 現在の主実装 |
|---|---|
| Queue 実行制御 | [ThumbnailQueueProcessor.cs](../src/IndigoMovieManager.Thumbnail.Queue/ThumbnailQueueProcessor.cs) |
| Queue 状態保持 | [QueueDbService.cs](../src/IndigoMovieManager.Thumbnail.Queue/QueueDb/QueueDbService.cs) |
| 実行Facade | [ThumbnailCreationRuntime.cs](./ThumbnailCreationRuntime.cs) |
| 実処理の窓口 | [ThumbnailCreationFacade.cs](./ThumbnailCreationFacade.cs) |
| 事前判定 | [ThumbnailPreflightChecker.cs](./ThumbnailPreflightChecker.cs) |
| 失敗時プレースホルダー | [ThumbnailPlaceholderUtility.cs](./ThumbnailPlaceholderUtility.cs) |
| 修復ワークフロー | [ThumbnailRepairWorkflowCoordinator.cs](./ThumbnailRepairWorkflowCoordinator.cs) |
| 最終失敗固定 | [ThumbnailFailureFinalizer.cs](./ThumbnailFailureFinalizer.cs) |
| 欠損救済入口 | [MainWindow.Watcher.cs](../Watcher/MainWindow.Watcher.cs) |
