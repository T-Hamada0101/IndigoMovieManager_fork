...
- 親レビューでは、Worker Franklin の Phase0 summary 可読性補強を採用した。optional evidence が1件以上ある時だけ `optional_evidence=x/28` を `optional=...` の前に出す。optional 0件の summary、Phase0 必須12件、optional 28件、完了条件は変えていない。
