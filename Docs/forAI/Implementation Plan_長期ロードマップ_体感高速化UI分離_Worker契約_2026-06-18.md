...
- 済: manual reload / image aggregate-decode-plan / image stale discard は optional evidence として summary に残す。採取時の補助情報であり、Phase0 必須12件の完了条件は増やさない。
