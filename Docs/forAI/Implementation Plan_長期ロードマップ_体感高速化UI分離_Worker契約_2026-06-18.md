...
- 済: Everything poll と watch apply の成功経路も scheduler admitted / released ログを持つ。既存の実行入口は変えず、実機ログで入場成功と次実行引き渡しを同じ scheduler 契約で追える。
